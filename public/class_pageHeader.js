/**
 * La classe décrit le header de la page du projet, contenant les boutons permettant d'afficher la mindmap ou le diagramme
 * de Gantt, ainsi qu'un lien pour se déconnecter.
